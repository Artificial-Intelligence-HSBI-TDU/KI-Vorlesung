...
| Woche  | Thema      | Vorlesung: Selbststudium (Vorbereitung)                                                                                                                                                                                        | Vorlesung: Gemeinsame Sitzung                                                                                             | Aufgabenblatt                                           |
|:-------|:-----------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------|
...
| 06.10. | Intro      |                                                                                                                                                                                                                                | **ab 12:45**: [Einführung KI](lecture/intro/intro1-overview.md) \| [Problemlösen](lecture/intro/intro2-problemsolving.md) | [Blatt: Naive Bayes](homework/sheet-nb.md)              |
...
| 17.11. | Perzeptron |                                                                                                                                                                                                                                | [Perzeptron](lecture/nn/nn01-perceptron.md)                                                                               | [Blatt: DTL](homework/sheet-dtl.md)                     |
